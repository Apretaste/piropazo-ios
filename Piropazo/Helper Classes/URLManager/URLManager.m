...
- (void)postUrlCallForReg:(NSString*)path withParameters:(NSMutableDictionary*)dictionary
{
    NSString * urlStr = [NSString stringWithFormat:@"%@",path];
    //    NSMutableURLRequest *theRequest = [[NSMutableURLRequest alloc] init] ;
    //    NSURL *url=[NSURL URLWithString:urlStr];
    ...
    [theRequest setHTTPShouldHandleCookies:NO];
//    [theRequest setTimeoutInterval:30];
    [theRequest setTimeoutInterval:70];
...
- (NSString *)postStringFromDictionaryReg:(NSMutableDictionary*)dictionary
{
    NSString *argumentStr = @"";
